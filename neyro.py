...
def calc_discriptor(model, input_image):
...
def find_images(model, image):
    probabilities = calc_discriptor(model, image)
    find_image = []
    find_image = DBImage.search_image(probabilities)
    return find_image